...
public class ImageGenerator {
	...
	/**
	 * Instantiate a generator for the specified painter object with default
	 * size and filename.
	 * 
	 * @param painter
	 *            The painter object.
	...
	/**
	 * Instantiate a generator for the specified painter object with supplied
	 * size and filename.
	 * 
	 * @param painter
	 *            The painter object.
	 ...
	 * @param imgformat
	 *            String describing the desired image format. Supported formats:
	 *            "png".
	 */
	public ImageGenerator(Painter painter, int width, int height,
			String filename, String imgformat) {
		generate(painter, width, height, filename, imgformat);
	}

	/**
	 * Convenience function- try to open an appropriate viewer and show the
	 * image file
	 */
	...
	private boolean generate(Painter painter, int width, int height,
			String filename, String imgformat) {
