...
public class Main {
	...
	public static void main(String[] args) {
		...
		lights.add(new LightSource(new Vector(-3, 4, -4), yellow)); 

		final Material material = new Material(red, green, blue, 64); 
		...
		Scene scene = new Scene(objects, lights, yellow, camera);
		...
		Sphere redSphere = new Sphere(new Vector(1.0f, 0.0f, -5.0f), 1.3f, material);
		...
		//AxisAllignedBox box = new AxisAllignedBox(new Vector(2, 1, -12), new Vector(6, 5, -10), boxColor);
